...
char ssid[] = "LuoShiJu";                    // your network SSID (name)
char pass[] = "robocode00";                  // your network password
...
unsigned short const font1[96][9] = { { 0x07, 0x00, 0x00, 0x00, 0x00, 0x00,
        ...
        { 0x07, 0x1F, 0x11, 0x11, 0x11, 0x11, 0x11, 0x1F, 0x00 },   // 0x30, 0
        { 0x07, 0x04, 0x04, 0x04, 0x04, 0x04, 0x04, 0x04, 0x00 },   // 0x31, 1
        { 0x07, 0x1F, 0x01, 0x01, 0x1F, 0x10, 0x10, 0x1F, 0x00 },   // 0x32, 2
        { 0x07, 0x1F, 0x01, 0x01, 0x1F, 0x01, 0x01, 0x1F, 0x00 },   // 0x33, 3
        { 0x07, 0x11, 0x11, 0x11, 0x1F, 0x01, 0x01, 0x01, 0x00 },   // 0x34, 4
        { 0x07, 0x1F, 0x10, 0x10, 0x1F, 0x01, 0x01, 0x1F, 0x00 },   // 0x35, 5
        { 0x07, 0x1F, 0x10, 0x10, 0x1F, 0x11, 0x11, 0x1F, 0x00 },   // 0x36, 6
        { 0x07, 0x1F, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x00 },   // 0x37, 7
        { 0x07, 0x1F, 0x11, 0x11, 0x1F, 0x11, 0x11, 0x1F, 0x00 },   // 0x38, 8
        { 0x07, 0x1F, 0x11, 0x11, 0x1F, 0x01, 0x01, 0x1F, 0x00 },   // 0x39, 9
...
tm* connectNTP() { //if response from NTP was succesfull return *tm else return a nullpointer
    ...
    epoch = secsSince1900 - seventyYears + 3600*7 + 2; //+2000ms Verarbeitungszeit
